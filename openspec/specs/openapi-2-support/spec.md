...
Support parsing and querying OpenAPI 2.0 (Swagger) specification files, normalizing their structure to an internal 3.0-like representation so all existing commands work identically on 2.0 specs.
