...
Provide field-level search across all schemas and endpoint parameters, allowing users to find which schemas or endpoints contain a given field name or description.
